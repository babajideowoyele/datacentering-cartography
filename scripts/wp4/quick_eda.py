...
ax.bar(years, [yr_all.get(y,0) for y in years], color="#dadada", label="All articles", zorder=2)
ax.bar(years, [yr_con.get(y,0) for y in years], color=C_DARK, label="Contestation", zorder=3)
...
ax.plot(years, [rates[y] for y in years], color=C_DARK, linewidth=2, marker="o", markersize=4)
ax.fill_between(years, [rates[y] for y in years], alpha=0.1, color=C_DARK)
